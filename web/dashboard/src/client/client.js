...
export default class GimletClient {
  ...
  saveEnvConfig = (owner, name, env, configName, formData, namespace) => this.postWithAxios(`/api/repo/${owner}/${name}/env/${env}/config/${configName}`, JSON.stringify({ formData, namespace }));
