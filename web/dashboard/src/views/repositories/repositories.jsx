...
const Spinner = () => {
  return (
    <div className="max-w-7xl grid place-items-center mx-auto px-4 sm:px-6 lg:px-8">
      <div role="status">
        <svg className="inline mr-2 w-32 h-32 text-gray-200 animate-spin dark:text-gray-200 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
