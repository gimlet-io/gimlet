                    ...
                    <div className="overflow-hidden inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                        <table className="min-w-full divide-y divide-neutral-300">
                            <thead className="bg-neutral-50">
                                <tr>
                                    <th scope="col" className="py-3.5 pl-4 text-left text-sm font-semibold text-neutral-900 sm:pl-6">
                                        Variable
                                    </th>
                            ...
                            <tbody className="bg-white">
                                {variables.map((variable, variableIdx) => (
                                    <tr key={variable.variable} className={variableIdx % 2 === 0 ? undefined : 'bg-neutral-50'}>
                                        <td className="whitespace-normal py-4 pl-4 pr-3 text-sm font-medium text-neutral-900 sm:pl-6">
                                            {variable.variable}
                                        </td>
                                        <td className="relative whitespace-normal p-4 px-3 py-4 text-left text-sm text-neutral-500">{variable.value}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
