        ...
        <div className="max-w-4xl mx-auto">
          <div className="md:flex md:items-center md:justify-between">
            <div className="flex-1 min-w-0">
              <div className="mx-auto max-w-md py-8 card px-10">
                <div className="my-8">
                  <img src="/logo-new.svg" alt="Gimlet" className='h-12 w-auto block dark:hidden mx-auto' />
                  <img src="/logo-dark.svg" alt="Gimlet" className='h-12 w-auto hidden dark:block mx-auto' />
                  <div className="my-16 text-base font-medium text-neutral-700">
                    {loginButton(provider, redirect)}
                    {provider === "" &&
                      <form action="/admin-key-auth" method="post">
                        <div className="space-y-8">
                          <div className="space-y-1">
                            <label htmlFor="token" className="text-neutral-700 dark:text-neutral-300 mr-4 block text-sm">
                              Admin key
                            </label>
                            <input
                              type="text"
                          ...
                          <button
                            type="submit"
                            disabled={token === ""}
                            className={token === "" ? "primaryButtonDisabled px-20 py-4" : "primaryButton px-20 py-4"}
                          >
                  ...
                  {termsOfServiceFeatureFlag && <div className="text-center font-light text-neutral-700 flex flex-wrap justify-center">
  ...
  if (provider === "GitHub") {
    return (
      <button
        ...
        className="primaryButton px-20 py-4"
      >
        <svg width="32" height="32" className="mr-2 fill-current" viewBox="0 -3 256 256" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
    ...
    return (
      <button
        ...
        className="inline-flex items-center justify-center w-full font-medium px-20 py-3 rounded border border-neutral-300 hover:bg-neutral-50 shadow-sm"
      >
