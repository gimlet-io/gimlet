...
const Timeline = ({ alerts }) => {
  ...
  return (
    <div>
      <div className="h-8">
        <div className="flex justify-end divide-x space-x-1 divide-neutral-300 text-neutral-500 dark:text-neutral-400 text-xs pb-0.5">
          {hours.map(hour => {
            return (
              <button
                  key={hour.hour}
        ...
        <div className="relative flex bg-green-300 dark:bg-teal-600 h-6">
