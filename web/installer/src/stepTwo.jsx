...
const StepTwo = ({appId, repoPerEnv}) => {
    return (
          ...
          <form action="/bootstrap" method="post">
            <div class="mt-8 text-sm"
              x-data="{
                env: 'production',
                repoPerEnv: false,
                useExistingPostgres: false,
                hostAndPort: 'postgresql:5432',
                dashboardDb: 'gimlet_dashboard',
                dashboardUsername: 'gimlet_dashboard',
                dashboardPassword: '',
                gimletdDb: 'gimletd',
                gimletdUsername: 'gimletd',
                gimletdPassword: '',
                infra: 'gitops-infra',
                apps: 'gitops-apps'
              }" x-effect="
                infra = repoPerEnv ? `gitops-${env}-infra` : 'gitops-infra';
                apps = repoPerEnv ? `gitops-${env}-apps` : 'gitops-apps';
              ">
                ...
                <div class="flex">
                  ...
                  <div class="ml-3 md:justify-between">
                    <p class="text-sm text-blue-500">
                      By default, infrastructure manifests of this environment will be placed in the <span x-text="env"
                        class="text-xs font-mono bg-blue-100 text-blue-500 font-medium px-1 py-1 rounded"></span>
                      ...
                      and application manifests will be placed in the <span
                        class="text-xs font-mono bg-blue-100 text-blue-500 font-medium px-1 py-1 rounded" x-text="env"></span>
                      folder of the shared <span
              ...
              <div class="flex mt-4">
                <div class="font-medium self-center">Separate environments by git repositories</div>
                <div class="max-w-lg flex rounded-md ml-4">
                  <button onClick={"repoPerEnv = ! repoPerEnv"} type="button"
                    ...
                    <span className={repoPerEnv ? 'translate-x-5' : 'translate-x-0'}>
                      <span aria-hidden="true"
                        class="pointer-events-none inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-200">
                      </span>
                    </span>
                  </button>
                  <input id="repoPerEnv" name="repoPerEnv" type="hidden" x-model="repoPerEnv"/>
                </div>
              </div>
              <div class="text-sm text-gray-500 leading-loose">Manifests will be placed in environment specific repositories
              </div>
    
              <div class="ml-8" x-show="repoPerEnv">
                <div class="flex mt-4">
                  <div class="font-medium self-center">Infrastructure git repository</div>
                  <div class="max-w-lg flex rounded-md ml-4">
                    <div class="max-w-lg w-full lg:max-w-xs">
                      <input id="infra" name="infra"
                        class="block w-full p-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        type="text" x-model="infra" />
                    </div>
                  </div>
                </div>
                <div class="text-sm text-gray-500 leading-loose">Infrastructure manifests will be placed in the root of the
                  specified repository</div>
                <div class="flex mt-4">
                  <div class="font-medium self-center">Application git repository</div>
                  <div class="max-w-lg flex rounded-md ml-4">
                    <div class="max-w-lg w-full lg:max-w-xs">
                      <input id="apps" name="apps"
                        class="block w-full p-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        type="text" x-model="apps" />
                    </div>
                  </div>
                </div>
                <div class="text-sm text-gray-500 leading-loose">Application manifests will be placed in the root of the
                  specified repository</div>
              </div>
              ...
              <div class="flex mt-4">
                ...
                <div class="max-w-lg flex rounded-md ml-4">
                  ...
                  <input id="useExistingPostgres" name="useExistingPostgres" type="hidden" x-model="useExistingPostgres"/>
                </div>
              </div>
              ...
              <div class="ml-8" x-show="useExistingPostgres">
                <div class="flex mt-4">
                  ...
                  <div class="max-w-lg flex rounded-md ml-4">
                    <div class="max-w-lg w-full lg:max-w-xs">
                      <input id="dashboardUsername" name="dashboardUsername"
                        class="block w-full p-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        type="text" x-model="dashboardUsername" />
                    </div>
                  </div>
                </div>
                <div class="flex mt-4">
                  ...
                  <div class="max-w-lg flex rounded-md ml-4">
                    <div class="max-w-lg w-full lg:max-w-xs">
                      <input id="dashboardPassword" name="dashboardPassword"
                        class="block w-full p-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        type="text" x-model="dashboardPassword" />
                    </div>
                  </div>
                </div>
                <div class="flex mt-4">
                  ...
                  <div class="max-w-lg flex rounded-md ml-4">
                    <div class="max-w-lg w-full lg:max-w-xs">
                      <input id="gimletdUsername" name="gimletdUsername"
                        class="block w-full p-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        type="text" x-model="gimletdUsername" />
                    </div>
                  </div>
                </div>
                <div class="flex mt-4">
                  ...
                  <div class="max-w-lg flex rounded-md ml-4">
                    <div class="max-w-lg w-full lg:max-w-xs">
                      <input id="gimletdPassword" name="gimletdPassword"
                        class="block w-full p-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        type="text" x-model="gimletdPassword" />
                    </div>
                  </div>
                </div>
              </div>
