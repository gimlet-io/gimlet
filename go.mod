...
require (
	...
	github.com/gimlet-io/gimletd v0.5.2
...
require (
	...
	github.com/fluxcd/pkg/apis/kustomize v0.0.1 // indirect
	github.com/fluxcd/pkg/runtime v0.11.0 // indirect
	...
	sigs.k8s.io/kustomize/api v0.7.4 // indirect
