...
func Test_create(t *testing.T) {
	t.Run("Should resolve git@github.com:gimlet-io/onechart.git format chart names from git", func(t *testing.T) {
		...
		expectedChartName := "git@github.com:gimlet-io/onechart.git?path=/charts/onechart/"
		assert.Equal(t, expectedChartName, m.Chart.Name, "Should resolve chart repo URL")
	})
}
