```
tar -cvzf gimlet-documentation.tar.gz -C /tmp/gitops-3466480197 .

"/tmp/gitops-3466480197"

make build-image-builder
docker run --rm -it -v "$PWD":/usr/src/app -w /usr/src/app -p 8000:9000 paketobuildpacks/builder ./build/image-builder
...
curl -F 'image=192.168.50.129:5000/gimlet-documentation:latest' -F 'data=@/home/laszlo/projects/gimlet-documentation.tar.gz' http://localhost:8000/build-image
