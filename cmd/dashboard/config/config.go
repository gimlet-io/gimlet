...
const DEFAULT_CHARTS = "name=onechart,repo=https://chart.onechart.dev,version=0.57.0;name=static-site,repo=https://chart.onechart.dev,version=0.57.0"
...
type Config struct {
	...
	GitopsUpdaterFeatreFlag        bool   `envconfig:"FEATURE_GITOPS_UPDATER"`
